// Write a Java program to find possible distinct paths from the top-left corner
// to the bottom-right corner of a given grid (m x n).
// Note: You can move either down or right at any point in time.
// Sample Output: Unique paths number: 3
public class Main {
    public static void main(String[] args) {
        int m = 3;
        int n = 2;
        System.out.println("Unique paths number: "+unique_Paths(m, n));
    }
